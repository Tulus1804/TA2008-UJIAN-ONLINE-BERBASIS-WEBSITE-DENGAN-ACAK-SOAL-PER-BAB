...
<div id="page">
	...
	<!-- Content -->
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(<?= base_url() ?>assets/dist/learn/images/bg.jpg);" data-stellar-background-ratio="0.5">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-push-5 animate-box">
						<img class="img-responsive" src="<?= base_url(); ?>/assets/img/work_1.png" alt="work">
					</div>
