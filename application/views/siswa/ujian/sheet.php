...
if (time() >= $soal->waktu_habis) {
    ...
    Anda telah mengikuti ujjian!
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
    </button>
    </div>');
    redirect('siswa/ujian/' . $ujian->id_kelas, 'location', 301);
}
?>
<div class="row">
    <div class="col-sm-3">
    ...
    <div class="col-sm-9">
        ...
        <div class="box box-primary">
            ...
            <div class="box-footer text-center">
                ...
                <input type="hidden" name="id_kelas" id="id_kelas" value="<?= $ujian->id_kelas; ?>">
...
<script src="<?= base_url() ?>assets/js/app/ujian/sheet.js"></script>